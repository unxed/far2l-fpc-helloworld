...
const
  ...
  // from fpcbuild-3.2.2/fpcsrc/rtl/win/wininc
...
type
  ...
  // from https://www.freepascal.org/daily/packages/winunits-jedi/jwawincon/_char_info.html

  TCharUnion = record
    case Integer of
      0: (
          UnicodeChar: WCHAR; // WideChar is guess
        );
      1: (
          AsciiChar: Char;
        );
  ...
  // from https://www.freepascal.org/docs-html/rtl/types/tfiletime.html
  ...
  // from fpcbuild-3.2.2/fpcsrc/rtl/win/wininc/struct.inc
